...
| 관계 타입 | Precision | Recall | F1 | Support |
|-----------|-----------|--------|----|---------|
| `attr`    | 0.9991 | 0.9993 | 0.9992 | 8,059 |
| `part`    | 1.0000 | 0.9524 | 0.9756 | 21 |
| `up_down` | 0.9982 | 0.9982 | 0.9982 | 3,428 |

| 지표 | Precision | Recall | F1 | Support |
|------|-----------|--------|----|---------|
| Accuracy / Micro | 0.9989 | 0.9989 | 0.9989 | 11,508 |
| Macro 평균 | 0.9991 | 0.9833 | 0.9910 | 11,508 |
| Weighted 평균 | 0.9989 | 0.9989 | 0.9989 | 11,508 |
